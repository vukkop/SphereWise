      ...
      <div className='container mx-auto'>
        ...
        <div className="w-full px-4 flex flex-wrap">
          ...
          <div className="w-4/5 mx-auto text-left">
            <div id='0' onMouseEnter={() => adjustStepClasses(0)} onMouseLeave={() => resetStepClasses(0)} className="md:max-w-xl lg:-ml-20 my-8 md:h-40 card bg-base-100 shadow-xl transition ease-in-out hover:-translate-y-1 hover:scale-105 hover:bg-sky-700 hover:text-white duration-300">
            ...
            <div id='1' onMouseEnter={() => adjustStepClasses(1)} onMouseLeave={() => resetStepClasses(1)} className="md:max-w-xl mb-8 md:h-40 card bg-base-100 shadow-xl transition ease-in-out hover:-translate-y-1 hover:scale-105 hover:bg-sky-700 hover:text-white duration-300">
              <div className="card-body">
            ...
            <div id='2' onMouseEnter={() => adjustStepClasses(2)} onMouseLeave={() => resetStepClasses(2)} className="md:max-w-xl lg:ml-20 mb-8 md:h-40 card bg-base-100 shadow-xl transition ease-in-out hover:-translate-y-1 hover:scale-105 hover:bg-sky-700 hover:text-white duration-300">
              <div className="card-body">
            ...
            <div id='3' onMouseEnter={() => adjustStepClasses(3)} onMouseLeave={() => resetStepClasses(3)} className="md:max-w-xl lg:ml-40 md:h-40 card bg-base-100 shadow-xl transition ease-in-out hover:-translate-y-1 hover:scale-105 hover:bg-sky-700 hover:text-white duration-300">
              <div className="card-body">
